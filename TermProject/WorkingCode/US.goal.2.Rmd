...
4. Best Parameters shown in below table. The best hyperparameters based on this grid search are 16 repetitions and 1 hidden layers, and allow.det.season = FALSE .
