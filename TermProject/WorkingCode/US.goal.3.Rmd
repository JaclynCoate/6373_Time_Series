...
5. Load the forecasted positive and increase positive in a data frame
...
```{r}
us7 = predict(us.mlr.model, newxreg = regressions7)

us90 = predict(us.mlr.model, newxreg = regressions90)
```

7. Plotted Forecasts

```{r}
plot(seq(1,187,1), us$hospitalizedCurrently, type = "l", xlim = c(0,195), ylim = c(0,3000000), ylab = "Currently Hospitalized COVID Cases", main = "7 Day Forecast for COVID Hospitalized Cases")
