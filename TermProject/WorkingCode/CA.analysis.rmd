...
ASE of tuned MLP model

```{r}
mlp_uni2_90_t <- mlp(ts(Totalhosp_ts[1:112]), reps = 16, hd = 1, allow.det.season = FALSE)
fore_mlp_uni2_7_t <- forecast(mlp_uni2_90_t , h=7) #univariate 7 day mlp forecast

#Calculate ASE
ASE = mean((Totalhosp[113:119] - fore_mlp_uni2_7_t$mean)^2)
ASE
```
...
90 Day Forecast with MLR Model
